...
@section('content')
    <section class="centro">
        ...
        <article class="conteudo">
            <form method="post" action="{{ route("createColaborador") }}">
                @csrf
                    ...
                    <tbody>
                        @foreach ($colaboradores as $exibe)
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("edit-colaborador", Crypt::encrypt($exibe->id))}}"><i class="fa-solid fa-square-pen" id="btn-table-blue"></i></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
