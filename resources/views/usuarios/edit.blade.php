...
@section('content')
    <section class="centro">
        <header class="cabecalho">
            <h1 class="cabecalho-title"><a href="{{ route('homepage') }}">Homepage</a> / <a
                    href="{{ route('cadastros') }}">Cadastros</a> / <a href='{{ route('create-usuario') }}'>Usuários</a> /
                Ediçao de usuário</h1>
            </h1>
            ...
            <form method="post" action="{{ route('editUser', $exibir->id) }}">
                ...
                <label for="nome">
                    ...
                    <div>
                        ...
                        <input type="text" name="nome" id="nome" placeholder="Complete com o nome"
                            value="{{ $exibir->nome }}">
                    </div>
                    @error('nome')
                ...
                <label for="usuario">
                    ...
                    <div>
                        ...
                        <input type="text" name="usuario" id="usuario" placeholder="Complete com o usuário"
                            value="{{ $exibir->usuario }}">
                    </div>
                    @error('usuario')
                        <p id="input-error">{{ $message }}</p>
                        <style>
                ...
                <label for="email">
                    ...
                    <div>
                        ...
                        <input type="email" name="email" id="email" placeholder="Complete com o e-mail"
                            value="{{ $exibir->email }}">
                    </div>
                    @error('email')
                        <p id="input-error">{{ $message }}</p>
                ...
                @if (
                        ...
                        session("usuario.usuario") === $exibir->usuario
                    )
                    <label for="site">
                        <p>Site<span> *</span></p>
                        <div>
    ...
    <div id="float-buttons">
        <a href="{{ route('edit-senha', Crypt::encrypt($exibir->id)) }}"><button type="button" id="float-button"><i
                    class="fa-solid fa-key"></i></button></a>
...
@section('executa-confirmacao')
    <a href="{{ route('deleteUsuario', Crypt::encrypt($exibir->id)) }}"><button type="button"
            id="btn-red">Excluir</button></a>
@endsection
@endsection
