...
@section('content')
    ...
    <section class="centro">
        <header class="cabecalho">
            <h1 class="cabecalho-title"><a href="{{ route('homepage') }}">Homepage</a> / <a href="{{ route('cadastros') }}">Cadastros</a> / <a href='{{ route('create-usuario') }}'>Usuários</a> / Ediçao de usuário</h1></h1>
    ...
    <div id="float-buttons">
        <a href="{{route("edit-senha", Crypt::encrypt($exibir->id)) }}"><button type="button" id="float-button"><i class="fa-solid fa-key"></i></button></a>
    ...
    @section('executa-confirmacao')
        <a href="{{ route("deleteUsuario", Crypt::encrypt($exibir->id)) }}"><button type="button" id="btn-red">Excluir</button></a>
    @endsection
@endsection
