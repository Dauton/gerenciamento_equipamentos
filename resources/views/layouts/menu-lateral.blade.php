...
<nav class="menu-lateral">
    ...
    <ul>
        ...
        @elseif(session('usuario.perfil') === 'ADMIN')
            ...
            <ol class="menu-dropdown-02">
                <li><a href="{{ route('relatorios') }}"><i class="fa-solid fa-hourglass-half"></i>Entregas temporárias</a></li>
        ...
        <li><a href="{{ route('update-senha', Crypt::encrypt(session('usuario.id'))) }}"><i
