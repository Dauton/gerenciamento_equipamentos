...
@section('content')
    ...
    <section class="centro">
        ...
        <article class="conteudo">
            <form method="post" action="{{ route("createDepartamento") }}">
                @csrf
                ...
                <table class="DataTable">
                    ...
                    <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{route("edit-departamento", Crypt::encrypt($exibe->id))}}"><i class="fa-solid fa-square-pen" id="btn-table-blue"></i></a>
                                </td>
                            </tr>
                            @endforeach
                    </tbody>
